...
resources/services/observatorium-template.yaml: services/observatorium.libsonnet services/observatorium-template.jsonnet configuration/observatorium/rbac.libsonnet $(JSONNET) $(GOJSONTOYAML) $(JSONNETFMT)
