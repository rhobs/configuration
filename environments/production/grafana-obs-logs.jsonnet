...
local dashboards = {
  ...
  'grafana-dashboard-observatorium-api-logs.configmap':
    local configmap = k.core.v1.configMap;
    configmap.new() +
    configmap.mixin.metadata.withName('grafana-dashboard-observatorium-api-logs') +
    configmap.withData({
      'observatorium-api-logs.json': std.manifestJsonEx(
        {
          annotations: {
            list: [
              {
          ...
          description: 'The Observatorium API is the entrypoint for read and push log requests',
          editable: true,
          gnetId: null,
          graphTooltip: 1,
          ...
          panels: [
            {
              ...
              id: 116,
              panels: [],
              title: '/query & /labels & /label_values',
              type: 'row',
            },
            {
              cacheTimeout: null,
            ...
            },
            {
              ...
              targets: [
                {
                  expr: 'sum(rate(http_request_duration_seconds_bucket{group="logsv1",handler="query_range",le="60",code!~"5.."}[28d]))\n/\nsum(rate(http_request_duration_seconds_count{group="logsv1",handler="query_range"}[28d]))',
                  instant: true,
                  refId: 'A',
                },
              ],
            ...
            },
            {
              ...
              targets: [
                {
                  expr: 'sum(increase(http_request_duration_seconds_bucket{group="logsv1",handler="query_range",le="120",code!~"5.."}[28d]))\n/\nsum(increase(http_request_duration_seconds_count{group="logsv1",handler="query_range"}[28d]))',
                  instant: true,
                  refId: 'A',
                },
              ],
