...
require (
	...
	github.com/observatorium/up v0.0.0-20221027030018-d8bb06fa1e34
...
replace github.com/observatorium/observatorium => github.com/thibaultmg/observatorium v0.0.0-20231219093645-3697aab35544
