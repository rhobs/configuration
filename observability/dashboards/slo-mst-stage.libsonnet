    ...
    panels: [
      ...
      },
      {
        ...
        targets: [
          {
            exemplar: true,
            expr: 'histogram_quantile(0.9, sum by (le) (rate(up_custom_query_duration_seconds_bucket{namespace="observatorium-mst-stage",query="query-path-sli-1M-samples"}[1d])))',
            hide: false,
            interval: '',
            legendFormat: '',
            refId: 'A',
      ...
      },
      {
        ...
        targets: [
          {
            exemplar: true,
            expr: 'histogram_quantile(0.9, sum by (le) (rate(up_custom_query_duration_seconds_bucket{namespace="observatorium-mst-stage",query="query-path-sli-10M-samples"}[1d])))',
            hide: false,
            interval: '',
            legendFormat: '',
            refId: 'A',
      ...
      },
      {
        ...
        targets: [
          {
            exemplar: true,
            expr: 'histogram_quantile(0.9, sum by (le) (rate(up_custom_query_duration_seconds_bucket{namespace="observatorium-mst-stage",query="query-path-sli-100M-samples"}[1d])))',
            hide: false,
            interval: '',
            legendFormat: '',
            refId: 'A',
