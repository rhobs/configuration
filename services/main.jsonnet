...
local gubernator = (import 'github.com/observatorium/observatorium/deployments/components/gubernator.libsonnet');

local observatorium =
  (import 'github.com/observatorium/observatorium/deployments/components/observatorium.libsonnet') +
