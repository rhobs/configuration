local obs = import 'observatorium.libsonnet';
{
  ...
  parameters: [
    ...
    { name: 'THANOS_COMPACTOR_LOG_LEVEL', value: 'debug' },
    ...
    { name: 'THANOS_QUERIER_LOG_LEVEL', value: 'debug' },
    ...
    { name: 'THANOS_RECEIVE_LOG_LEVEL', value: 'debug' },
    ...
    { name: 'THANOS_RULER_LOG_LEVEL', value: 'debug' },
    ...
    { name: 'THANOS_STORE_LOG_LEVEL', value: 'debug' },
    ...
    { name: 'THANOS_REQUEST_LOGGING_LEVEL', value: 'DEBUG' },
  ],
}
