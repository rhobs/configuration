    ...
    stores:: t.storeShards(thanosSharedConfig {
      ...
      indexCache: {
        ...
        config+: memcachedDefaults {
          ...
          max_idle_connections: '!!int ${INDEX_CACHE_MAX_IDLE_CONNECTIONS}',
          max_async_buffer_size: '!!int ${INDEX_CACHE_MAX_ASYNC_BUFFER_SIZE}',
          max_async_concurrency: '!!int ${INDEX_CACHE_MAX_ASYNC_CONCURRENCY}',
          max_get_multi_batch_size: '!!int ${INDEX_CACHE_MAX_GET_MULTI_BATCH_SIZE}',
          max_get_multi_concurrency: '!!int ${INDEX_CACHE_MAX_GET_MULTI_CONCURRENCY}',
