          ...
          tenants: [
            ...
            },
            {
              ...
              oidc: {
                ...
                clientSecret: '${CLIENT_SECRET}',
                issuerURL: 'https://sso.redhat.com/auth/realms/redhat-external',
                redirectURL: '${RHOBS_URL}/oidc/osd/callback',
                usernameClaim: 'preferred_username',
              },
              opa: {
            ...
            },
            {
              ...
              oidc: {
                ...
                clientSecret: '${CLIENT_SECRET}',
                issuerURL: 'https://sso.redhat.com/auth/realms/redhat-external',
                redirectURL: '${RHOBS_URL}/oidc/managedkafka/callback',
                usernameClaim: 'preferred_username',
              },
              opa: {
                url: 'http://127.0.0.1:8082/v1/data/observatorium/allow',
            ...
            },
            {
              ...
              oidc: {
                ...
                clientSecret: '${CLIENT_SECRET}',
                issuerURL: 'https://sso.redhat.com/auth/realms/redhat-external',
                redirectURL: '${RHOBS_URL}/oidc/rhacs/callback',
                usernameClaim: 'preferred_username',
              },
            },
            {
              ...
              oidc: {
                ...
                clientSecret: '${CLIENT_SECRET}',
                issuerURL: 'https://sso.redhat.com/auth/realms/redhat-external',
                redirectURL: '${RHOBS_URL}/oidc/cnvqe/callback',
                usernameClaim: 'preferred_username',
              },
            },
            {
              ...
              oidc: {
                ...
                clientSecret: '${CLIENT_SECRET}',
                issuerURL: 'https://sso.redhat.com/auth/realms/redhat-external',
                redirectURL: '${RHOBS_URL}/oidc/psiocp/callback',
                usernameClaim: 'preferred_username',
              },
            },
            {
              ...
              oidc: {
                ...
                clientSecret: '${CLIENT_SECRET}',
                issuerURL: 'https://sso.redhat.com/auth/realms/redhat-external',
                redirectURL: '${RHOBS_URL}/oidc/rhods/callback',
                usernameClaim: 'preferred_username',
              },
            },
            {
              ...
              oidc: {
                ...
                clientSecret: '${CLIENT_SECRET}',
                issuerURL: 'https://sso.redhat.com/auth/realms/redhat-external',
                redirectURL: '${RHOBS_URL}/oidc/rhoc/callback',
                usernameClaim: 'preferred_username',
              },
            },
            {
              ...
              oidc: {
                ...
                clientSecret: '${CLIENT_SECRET}',
                issuerURL: 'https://sso.redhat.com/auth/realms/redhat-external',
                redirectURL: '${RHOBS_URL}/oidc/odfms/callback',
                usernameClaim: 'preferred_username',
              },
            },
            {
              ...
              oidc: {
                ...
                clientSecret: '${CLIENT_SECRET}',
                issuerURL: 'https://sso.redhat.com/auth/realms/redhat-external',
                redirectURL: '${RHOBS_URL}/oidc/reference-addon/callback',
                usernameClaim: 'preferred_username',
              },
            },
          ],
